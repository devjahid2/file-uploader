    ...
    <>
      ...
      <div className="content pt-4 pb-3">
        <nav className="d-flex align-items-center justify-content-between nav-section">
          <div className="d-flex align-items-center gap-5">
            {smallDevice ? (
              <img
                ...
                className="nav-icon pointer-event"
                src={images.menu}
                alt="menu"
              />
            ) : (
              ...
              {smallDevice ? (
                <div className="text-end">
                  <img
                    ...
                    src={images.close}
                    alt="close"
                    className="pb-3 nav-icon pointer-event"
                  />
                </div>
              ) : (
                ""
          ...
          <Link className="default-btn login-btn" to="">
            Login
          </Link>
        </nav>
      </div>
